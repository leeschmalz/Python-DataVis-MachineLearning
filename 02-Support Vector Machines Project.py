...
sb.kdeplot(data=setosa['sepal_width'],data2=setosa['sepal_length'],cmap='plasma',shade=True,shade_lowest=False)
...
sb.kdeplot(data=versicolor['sepal_width'],data2=versicolor['sepal_length'],cmap='plasma',shade=True,shade_lowest=False)
...
sb.kdeplot(data=virginica['sepal_width'],data2=virginica['sepal_length'],cmap='plasma',shade=True,shade_lowest=False)
...
param_grid = {'C':[0.1,1, 10, 100],'gamma':[1,.1,.01,.001]}
...
predictions2 = grid_search.predict(X_test)
